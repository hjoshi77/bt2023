...
plt.plot(x_axis, norm.pdf(x_axis, 0, 10),color='C0')
plt.plot(x_axis, norm.pdf(x_axis, 0, 20),color="C1")
plt.plot(x_axis, norm.pdf(x_axis, mean, sd),color='C3')
...
plt.savefig('funtion_norm.png', format='png',bbox_inches='tight',dpi=300) 
